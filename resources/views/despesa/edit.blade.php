...
<html>
	<head lang="pt-br">
		<title>Editar despesa #{{ $despesa->id }} | GerFinc</title>
		<meta charset="utf-8">
			...
			<div class="row">
				<div class="col-12 col-md-7 col-lg-5 mx-auto">
					<div class="card shadow-sm">
						<div class="card-body">
							<h2 class="text-center">Editar despesa #{{ $despesa->id }}</h2>
							<form method="post" action="{{ route('despesas.update', ['despesa'=>$despesa->id]) }}">
								@csrf
								@method('PUT')
								<div class="form-group">
									<label>Descrição</label>
									<input class="form-control" type="text" name="descricao" value="{{ $despesa->descricao }}">
								</div>
								<div class="form-group">
									<label>Categoria</label>
									<input class="form-control" type="text" name="categoria" value="{{ $despesa->categoria }}">
								</div>
